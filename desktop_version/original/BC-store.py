...
class ExampleApp(QtWidgets.QMainWindow, designwhole.Ui_MainWindow):
    ...
    def viewset(self):
        string = '\nset1:\n1, 2, 3, 4' + \
                 ...
                 '\n\nsetbig:\n25, 26, 117, 28, 29, 30, 114, 32, \n33, 34, 35, 36, 37, 38, 39, 115, ' + \
                 '\n49, 50, 51, 52, 53, 116, 55, 56' + \
		 '\n\nsetOther:\n5, 6, 7, 8, 9, 10, 11, 12' + \
		 '\n17, 18, 19, 20, 21, 22, 23, 24' + \
		 '\n27, 31, 40, 54, 105, 106, 107, 108' + \
		 '\n109, 110, 111, 112, 113, 118, 119, 120' + \
                 '\n\nsetGC_ABCD:\n1A, 1B, 1C, 1D, \n2A, 2B, 2C, 2D, \n3A, 3B, 3C, 3D, \n4A, 4B, 4C, 4D, ' \
                 '\n13A, 13B, 13C, 13D, \n14A, 14B, 14C, 14D, \n15A, 15B, 15C, 15D, \n16A, 16B, 16C, 16D, ' \
                 '\n25A, 25B, 25C, 25D, \n26A, 26B, 26C, 26D, \n29A, 29B, 29C, 29D, \n32A, 32B, 32C, 32D, ' \
                 '\n33A, 33B, 33C, 33D, \n35A, 35B, 35C, 35D, \n36A, 36B, 36C, 36D, \n37A, 37B, 37C, 37D, ' \
    ...
    def checkset(self):
        ...
        names1 = [str(x.strip()) for x in str1.strip().split(',') if x]
